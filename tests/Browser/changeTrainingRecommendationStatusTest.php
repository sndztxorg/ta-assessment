...
class changeTrainingRecommendationStatusTest extends DuskTestCase
{
    /**
     * Mengubah Rekomendasi Pelatihan
     * @test
     * @return void
     */
    public function ChangeTrainingRecommendation()
    {
        $this->browse(function (Browser $browser) {
            $browser->visit('/') // mengakses homepage
                    ...
                    ->assertSee('Edit Data Rekomendasi Pelatihan') // mengecek apakah ada tulisan ini
                    ->radio('trainingType', 'Opsional') // memilih opsi Opsional
                    ...
                    ->script('console.log("Done Test : Ubah Sifat Training Recommendation")') // console log
                    ;
        });
    }
}
