...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="text-left">
            ...
            <h1 class="d-inline h3 text-gray-800">Edit Role Platform</h1>
        </div>
            ...
            <form action="{{ url('role/'.$role->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="id" id="id" class="form-control @error('id') is-invalid @enderror"
                        value="{{ old('id', $role->id) }}" autofocus placeholder="Masukan ID Role">
                    @error('id')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                        value="{{ old('name', $role->name) }}" autofocus placeholder="Masukan Nama Role..">
                    @error('name')
                        <div class="invalid-feedback"> {{ $message }}</div>
                    @enderror
                </div>
